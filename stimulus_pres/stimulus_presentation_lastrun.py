...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/brynnharrisshanks/Library/CloudStorage/OneDrive-DalhousieUniversity/NTX_hackathon/stimulus_presentation_lastrun.py',
